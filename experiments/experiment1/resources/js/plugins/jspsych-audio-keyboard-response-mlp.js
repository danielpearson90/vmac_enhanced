/**
* jspsych-audio-keyboard-response-mlp
* Josh de Leeuw
*
...
jsPsych.plugins["audio-keyboard-response-mlp"] = (function () {

    var plugin = {};

    jsPsych.pluginAPI.registerPreload('audio-keyboard-response-mlp', 'stimulus', 'audio');

    plugin.info = {
        name: 'audio-keyboard-response-mlp',
        description: '',
        parameters: {
            stimulus: {
